...
// ie: "Called from main(278)->PS::Game::ss(167)->..." is changed to "Called from main(278) -> PS::Game::ss(167) -> "
...
$pager = pagination(array(
	'baseurl'	=> psss_url_wrapper(array('sort' => $sort, 'order' => $order, 'limit' => $limit, 'filter' => $filter)),
	'total'		=> $total,
	'start'		=> $start,
	'perpage'	=> $limit, 
	'pergroup'	=> 5,
...
$cms->crumb('Error Logs', psss_url_wrapper(array('_base' => $php_scnm )));
