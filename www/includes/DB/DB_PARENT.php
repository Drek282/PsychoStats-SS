...
// these expressions are used in queries that combine teams together (ie: division pages)
...
// same as above but these are used for non-division pages that aren't compiled (team_sessions)
