...
INSERT INTO `psss_config_awards` (`id`, `enabled`, `idx`, `negative`, `name`, `groupname`, `phrase`, `expr`, `order`, `where`, `limit`, `format`, `description`)
  VALUES
    ...
    (6, 1, 60, 0, 'Highest Single Season Team Speed Rating', '', '{$team.link} has the highest historical single season team speed rating at {$award.topteamvalue} in {$award.awardseason}', '{$team_srat}', 'desc', '', 5, '%.2f', 'This Hall of Fame award is for the team with the highest single season team speed rating in league history.');
