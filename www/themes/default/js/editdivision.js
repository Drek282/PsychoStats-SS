...
function member_add(){
	...
	$.post('editdivision.php', params, function(data){
		if ($.trim(data) != 'error') {
...
function member_post() {
	...
	$.post('editdivision.php', { memberlist: 1, value: $('#member').val() }, function(data){
		list = $('#member-list');
		list.html(data);
...
function member_remove(){
	...
	$.post('editdivision.php', { id: divisionid, del: id, ajax: 1 }, function(data){
